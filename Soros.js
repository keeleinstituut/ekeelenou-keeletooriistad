/**
 * This is a slightly (e.g syntactically not semantically) modified version of László Németh's
 * Soros language as found on http://www.numbertext.org/
 * The program's license "Attribution-NoDerivs 2.0 Generic" (CC BY-ND 2.0) does not allow
 * this derivative to be distributed. Please refer to the original program code at the
 * numbertext homepage http://www.numbertext.org/
 *
 * Author for this modification is Kristian Kankainen,
 * Institute for Estonian Language (http://www.eki.ee/)
 */
...
function comp() {
		mySoros = new Soros(document.getElementById('numbrireeglid-formaalne').textContent);
}
function load_prg() {
